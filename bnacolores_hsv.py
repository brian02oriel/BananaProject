...
verde_bajos_1 = np.array([122, 100, 26], dtype=np.uint8)
verde_altos_1 = np.array([122, 100, 100], dtype=np.uint8)

verde_bajos_2 = np.array([72, 100, 35], dtype=np.uint8)
verde_altos_2 = np.array([72, 100, 100], dtype=np.uint8)
...
mascara_verde_1 = cv2.inRange(hsv, verde_bajos_1, verde_altos_1)
mascara_verde_2 = cv2.inRange(hsv, verde_bajos_2, verde_altos_2)
